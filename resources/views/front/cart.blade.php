                  ...
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      <tr id="cart_box{{$data->attr_id}}">
                        ...
                        <td id="total_price_{{$data->attr_id}}">₹ {{$data->qty * $data->price}}</td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <a class="aa-cartbox-checkout aa-primary-btn" href="{{url('/checkout')}}"><input class="aa-cart-view-btn"  value="CheckOut"></a>
