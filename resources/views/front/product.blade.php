                ...
                <div class="col-md-7 col-sm-7 col-xs-12">
                  <div class="aa-product-view-content">
                    ...
                    <div class="aa-price-block">
                      <span class="aa-product-view-price"><h4>Rs. {{$product_attr[$product[0]->id][0]->mrp}}</h4></span>
                    ...
                    @foreach($arrSize as $attr)
                      @if($attr!="")
                          <a href="javascript:void(0)" id="size_{{$attr}}" onclick="showColor('{{$attr}}')" class="size_link">{{$attr}}</a>
                      @endif
                    @endforeach
                    </div>
                    @endif
                        ...
                        <li>
                          <figure>  
                            ...
                            <figcaption>
                              ...
                              <span class="aa-product-price">Rs {{$related_product_attr[$productArr->id][0]->price}}</span><span class="aa-product-price"></span>
                            </figcaption>
                          </figure>    
