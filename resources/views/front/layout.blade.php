...
<html lang="en">
  <head>
    ...
    <title>Daily Shop | @yield('page_title')</title>
      ...
      <div class="modal-content">                      
        ...
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
          ...
          <form class="aa-login-form" id="frmLogin">
            ...
            <input type="text" name="str_login_email" placeholder="Email" value="{{$login_email}}" required>
          ...
          <div id="popup_forgot" style="display: none;">
            ...
            <form class="aa-login-form" id="frmForgot">
              @csrf
              <label for="">Email address<span>*</span></label>
              <input type="text" name="str_forgot_email" placeholder="Email" required>
              
              <button class="aa-browse-btn" id="btn_forgot" type="submit">Submit</button>
