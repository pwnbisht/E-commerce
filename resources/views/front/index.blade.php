        ...
        <div class="seq-screen">
          <ul class="seq-canvas">
            ...
            @foreach($home_banner as $list)
              <li>
                <div class="seq-model">
                  <img data-seq src="{{asset('storage/media/banners/'.$list->image)}}" alt="Men slide img" />
                </div>
                <div class="seq-title">
                  @if($list->off != "")
                  <span data-seq>"{{$list->off}}"</span> 
                  @endif               
                  <h2 data-seq>{{$list->banner_name}}</h2>                
                  <p data-seq>{{$list->banner_about}}</p>
                  <a data-seq target="blank" href="{{$list->btn_link}}" class="aa-shop-now-btn aa-secondary-btn">{{$list->btn_text}}</a>
                </div>
              </li>
            @endforeach
          </ul>
      ...
      <div class="row">
        <div class="col-md-12">        
          <div class="row">
            ...
            <a href="#"><img src="{{asset('storage/media/banners_1170x170/banner1.jpg')}}" alt="fashion banner img"></a>
          </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-md-12">
          <div class="aa-client-brand-area">
            <ul class="aa-client-brand-slider">
              ...
              <li><a href="#"><img src="{{asset('storage/media/brands/'.$list->image)}}" alt="{{$list->name}}"></a></li>
              @endforeach
            </ul>
          </div>
        </div>
