                        ...
                        <div class="panel-body">
                         <div class="row">
                          ...
                          <div class="row">
                            <div class="col-md-12">
                              <div class="aa-checkout-single-bill">
                                <textarea cols="8" rows="3" name="address" placeholder="Delivery Address" required>{{$customers['address']}}</textarea>
                              </div>                             
                            </div>                            
                          </div>   
                          <div class="row">
              ...
              <div class="col-md-4">
                <div class="checkout-right">
                  ...
                  <div class="aa-payment-method">                    
                    ...
                    <label for="instamojo"><input type="radio" id="instamojo" name="payment_type" value="Gateway"> Via Credit Card/Debit Card </label>
                    <!-- <img src="https://www.paypalobjects.com/webstatic/mktg/logo/AM_mc_vs_dc_ae.jpg" border="0" alt="PayPal Acceptance Mark">     -->
                    <input type="submit" value="Place Order" class="aa-browse-btn" id="btnplaceorder">  
                    <div id="order_placed_msg" class="order_placed_msg">
