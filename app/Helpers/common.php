...
function getTopNavCat(){
    ...
    foreach($result as $row){
        ...
        $arr[$row->id]['parent_id']=$row->paarent_category_id;
            ...
            if($result[0]->status==1){
                ...
                else
                {
                    ...
                    if($min_order_amt>0){
                        ...
                        {
                            $status="error";
                            $msg="Coupon is not available for this product. Cart ammount must be greater then ".$min_order_amt;
                        }
                    }
                    else
                    {
