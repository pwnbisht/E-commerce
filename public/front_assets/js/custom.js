...
/* ----------------------------------------------------------- */
/*  14. change product color image according to size
  /* ----------------------------------------------------------- */
...
/* ----------------------------------------------------------- */
/*  category page sort by name date price etc filter
/* ----------------------------------------------------------- */
    ...
    jQuery.ajax({
        ...
        success:function(result){
            ...
            if(result.status=="success")
            {
                ...
                jQuery('#reg_cmplt_msg').html(result.msg);
...
jQuery('#frmUpdatePassword').submit(function(e){
    ...
    jQuery.ajax({
        ...
        type:'post',
        success:function(result){
          jQuery('#forget_pass').html(result.msg);
            // if(result.status=="success")
            // {
            //     window.location.href = '/';
            // }
